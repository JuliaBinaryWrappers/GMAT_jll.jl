...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import GMAT_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("5472d9e0-cb42-52f7-96c9-a9fd19db341f"))
platforms = [Pkg.Artifacts.unpack_platform(e, "GMAT", artifacts_toml) for e in artifacts["GMAT"]]
...
if best_platform === nothing
    @debug("Unable to load GMAT; unsupported platform $(triplet(platform_key_abi()))")
else
